...
function ProjectSection() {
    ...
    return (
        <div className="grid grid-cols-1 gap-16 md:grid-cols-[1fr_2fr]" ref={target}>
            <div>
                <div ref={heading}>
                    <h2 className="mb-6 text-3xl/none font-medium tracking-tighter text-neutral-200">All Projects</h2>
                    <h3 className="text-base/snug tracking-tight text-neutral-400">
