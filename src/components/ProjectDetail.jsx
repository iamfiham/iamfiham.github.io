...
function ProjectDetail() {
    ...
    return (
        <div className="py-28">
            ...
            <h2 className="text-glow mb-20 text-4xl font-medium tracking-tight">Unmistakeably Stadia, undeniably Google.</h2>
            ...
            <div className="mb-20 grid grid-cols-2 items-start gap-16">
                ...
                <p className="text-base text-neutral-400" ref={target}>
                    At Google’s scale of design, it would be redundant to create an entirely new design system for this project. <br /> <br />
                    ...
                    <br /> <br />
                    Though, there was room for some fun! In the spirit of being forward-looking while also paying homage to the past, I fused together
